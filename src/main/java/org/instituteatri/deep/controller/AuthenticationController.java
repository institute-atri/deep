...
public class AuthenticationController {
    ...
    @Operation(
            ...
            description = "This endpoint handles user authentication. " +
                    "If a user enters an incorrect password more than four times, their account will be blocked. " +
                    "After successful login, it returns a token and a refresh token. " +
                    "To use the HTTP POST method, a CSRF token generated by the browser is required " +
    ...
    @Operation(
            ...
            description = "Registers a new user in the system. The user information should be provided in the request body. " +
    ...
    @Operation(
            ...
            description = "Endpoint to logout the currently authenticated user. " +
                    ...
                    "To use HTTP POST method, a CSRF token generated by the browser is required " +
                    "to protect against Cross-Site Request Forgery (CSRF) attacks.",
            parameters = @Parameter(
                    name = "X-XSRF-TOKEN",
                    required = true,
    ...
    @Operation(
            ...
            description = "This endpoint allows refreshing the access token using a valid refresh token. " +
                    "To use the HTTP POST method, a CSRF token generated by the browser is required " +
                    "to protect against Cross-Site Request Forgery (CSRF) attacks.",
            parameters = @Parameter(
                    name = "X-XSRF-TOKEN",

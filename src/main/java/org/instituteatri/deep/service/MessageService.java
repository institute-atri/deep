...
public class MessageService {
    ...
    public void saveOllama(Message request, String occurrenceId) {
        org.instituteatri.deep.model.Message msg = org.instituteatri.deep.model.Message.builder()
                .content(request.content()).role(Role.valueOf(request.role().toString())).build();
    ...
    public void saveGemini(org.instituteatri.deep.model.Message msg){
        msg.setCreatedAt(Instant.now());
